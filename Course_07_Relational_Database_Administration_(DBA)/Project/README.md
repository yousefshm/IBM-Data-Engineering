...
![Max Connections Configuration](max-connections.jpg)
...
![Grant Privileges to Role](grant-privs-to-role.jpg)
![Grant Role to User](grant-role.jpg)
...
![Database Backup](backup-database.jpg)
...
![Baseline Query Performance](query-base-line.jpg)
![Index Creation](index-creation.jpg)
...
![Indexed Query Performance](query-indexed.jpg)
...
![Supported Storage Engines](storage-engines.jpg)
![Table Storage Engine](storage-engine-type.jpg)
...
![Backup Automation Script](bash-script.jpg)
...
![Restore Table](restore-table.jpg)
...
![Datasette Index Creation](index-creation.jpg)
![Query Performance After Index](query-after-index.jpg)
